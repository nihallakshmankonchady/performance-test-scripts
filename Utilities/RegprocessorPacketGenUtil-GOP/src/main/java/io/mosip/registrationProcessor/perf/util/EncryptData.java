...
//	ObjectMapper objectMapper = new ObjectMapper();
	 ...
	 */
	public RegistrationPacketSyncDTO createSyncRequest(File f, String regType, PropertiesUtil prop) throws ParseException {
		...
		//registrationPacketSyncDto.setRequesttime(getTime(regId).toString() + "Z");
		 registrationPacketSyncDto.setRequesttime(getCurrTime(prop));
		...
		System.out.println("Sync JSON is " + new Gson().toJson(registrationPacketSyncDto));
	...
	public String getCurrTime(PropertiesUtil prop) {
		...
		System.out.println("Time added to sync request is " + timestamp);
		return timestamp;
	}
	...
	public LocalDateTime getTime(String registrationId) throws ParseException {
		...
		System.out.println("Time added to sync request is " + ldt.toString() + "Z");
		return ldt;
	}
