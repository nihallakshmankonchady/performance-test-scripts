...
public class HDFSAdapterImpl implements FileSystemAdapter {
	...
	public boolean checkFileExistence(String id, String filePath) {
		...
		try {
			...
			/*
			 * throw new
			 * FSAdapterException(HDFSAdapterErrorCode.HDFS_ADAPTER_EXCEPTION.getErrorCode()
	...
	public boolean copyFile(String sourcePacket, String sourceFilePath, String destinationPacket,
		...
		// LOGGER.info("Copying file from packet {} with path {} to packet {} with path
		// {}", sourcePacket, sourceFilePath,
	...
	public InputStream getFile(String id, String filePath) {
		...
		try {
			if (!fs.exists(inFile)) {
				/*
				 * throw new
				 * FSAdapterException(HDFSAdapterErrorCode.FILE_NOT_FOUND_EXCEPTION.getErrorCode
