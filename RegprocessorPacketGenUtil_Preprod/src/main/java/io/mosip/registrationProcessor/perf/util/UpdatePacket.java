...
public class UpdatePacket {
	...
	public Long getUINByRegId(String regId, String validToken,PropertiesUtil prop) {
		Response idRepoResponse = getIDRepoResponse(regId, validToken,prop);
		Long uin = null;
	...
	private Response getIDRepoResponse(String regId, String validToken,PropertiesUtil prop) {
		String idRepoUrl = "/idrepository/v1/identity/rid/" + regId + "?type=all";
		Response idRepoResponse = apiRequests.regProcGetIdRepo(idRepoUrl, validToken,prop);
