 ...
 *
 */
public class SyncRegistrationServiceImpl {
	...
	public SyncRegistrationServiceImpl() {
		...
		auditLogRequestBuilder = new AuditLogRequestBuilder();

		decryptor = new Decryptor();

		// ridValidator

		// syncRegistrationDao = new
	...
	public List<SyncResponseDto> validateRegId(SyncRegistrationDto registrationDto,
		...
		// "SyncRegistrationServiceImpl::validateRegId()::entry");
