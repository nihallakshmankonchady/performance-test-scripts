...
public class PropertiesUtil {
	...
	public String PROOF_OF_REGISTRATION;
	public String PROOF_OF_REGISTRATION_TYPE;
	...
	public PropertiesUtil(String configFile) {
		...
		COUNTRY_NAME = properties.getProperty("COUNTRY_NAME");
		RESIDENT_STATUS = properties.getProperty("RESIDENT_STATUS");
		BLOOD_GROUP = properties.getProperty("BLOOD_GROUP");
		PROOF_OF_REGISTRATION = properties.getProperty("PROOF_OF_REGISTRATION");
		PROOF_OF_REGISTRATION_TYPE = properties.getProperty("PROOF_OF_REGISTRATION_TYPE");
	}
}
